...
You can either download this repository through the web UI or use [git](https://git-scm.com) to clone it locally.

```sh
cd any/target/directory/
git clone https://github.com/EinMilchBoss/paging.git
```
